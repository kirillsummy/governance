...
В `backend/work` (`2b5b7a4`) процесс `complaint` расширен внутри универсального
...
же журналом. Миграция `0125` и тесты ещё не выполнялись, поэтому это готовность
к проверке, а не готовность test/production. Канон и чек-лист владельца БД:
