...
Main в исходном снимке — заготовка; исполняемый продукт в PR #3/#4. Подтверждение телефона, выбор услуги/студии/мастера/времени, свои заказы, история и запрос отмены.
