...
| [Тестовый клиент](https://201.51.9.79/client/) | Клиентское приложение на TEST | Релиз и HTTP 200 подтверждены 25.09 в [текущем состоянии](current-state.md); текущий deployed SHA повторно не проверен |
